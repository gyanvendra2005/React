...
const Footer = function () {
    return (
        <footer className="bg-white border-y dark:bg-gray-800  dark:text-white">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8  dark:text-white">
                <div className="md:flex md:justify-between  dark:text-white">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3  dark:text-white">
                        <div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center  dark:text-white">
                        © 2024
                        <a href="https://www.instagram.com/gyanvendra_2004/" className="hover:underline  dark:text-white">
                            gyanvendrasingh
                        </a>
                        . All Rights Reserved.
                    </span>
